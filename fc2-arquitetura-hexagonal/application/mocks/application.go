...
import (
	...
	application "github.com/hugaleno/go-hexagonal/application"
)
...
func (m *MockProductServiceInterface) Create(name string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServiceInterfaceMockRecorder) Create(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductServiceInterface)(nil).Create), name)
}
